    ...
    <div className="mt-4">
      {
        editModeEnabled ? (
          ...
          <div className="flex flex-col gap-y-6">
            ...
            <div className="flex flex-col">
              <span className="text-sm text-gray-500">Address of Insured:</span>
              <div className="text-primary text-sm">{insuredFormValues.address}</div>
            </div>

            <div className="flex flex-col">
              <span className="text-sm text-gray-500">Telephone number:</span>
              <div className="text-primary text-sm">{insuredFormValues.telephone}</div>
            </div>

            <div className="flex flex-col">
              <span className="text-sm text-gray-500">Email address:</span>
              <div className="text-primary text-sm">{insuredFormValues.email}</div>
            </div>
          </div>
        )
      }
