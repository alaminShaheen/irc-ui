...
const SidebarContents = (props: ISidebarContentProps) => {
  ...
  return (
    <FocusTrap>
      ...
      <div className="p-8 w-[360px] lg:w-[715px] min-h-full text-base-content bg-primary text-left">
        <div>
          ...
          <div className="flex flex-row justify-end w-full pt-10 lg:pt-0">
            {/* <div className="h-12 w-12 rounded-lg text-primary-5 border-2 border-secondary-25 flex justify-center items-center font-bold">
              EN
            </div> */}
            <Button
        ...
        <div className="overflow-y-auto max-h-calc">
          <ul>
            ...
            <li>
              <div
                className="text-primary-200 pl-0 ml-0 mt-8"
                id="toolsAndForms"
              >
                Tools & Forms
              </div>
