...
const SvgRocketShipIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g
      ...
      strokeWidth={2}
      clipPath="url(#rocket-ship-icon_svg__a)"
    >
    ...
    <defs>
      <clipPath id="rocket-ship-icon_svg__a">
        <path fill="#fff" d="M0 0h36v36H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgRocketShipIcon;
