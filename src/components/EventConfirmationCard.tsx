...
const EventConfirmationCard = () => {
  return (
    <div className="mx-4 w-full h-full bg-[url('src/assets/images/event-checkout-bg.png')] bg-contain bg-no-repeat p-4">
      ...
      <Button className="w-full p-4 border-dashed border-2 border-primary text-primary text-lg">Confirm above</Button>
    </div>
  );
};
